        ...
        <div class="row row-cols-1 row-cols-md-2 row-cols-xl-4 g-3">
                ...
                <div class="card radius-10" style="background:linear-gradient(135deg,#3b2818,#5a3b23);">
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            <h5 class="mb-0 text-white kpi-value"><?php echo e($totalApplicants ?? '1,254'); ?></h5>
            ...
            <div class="col">
                <div class="card radius-10" style="background:linear-gradient(135deg,#f9a90f,#ffcc4d);">
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            <h5 class="mb-0 text-white kpi-value"><?php echo e($todayApplications ?? '48'); ?></h5>
            ...
            <div class="col">
                <div class="card radius-10" style="background:linear-gradient(135deg,#2b9348,#4bb368);">
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            <h5 class="mb-0 text-white kpi-value"><?php echo e($admittedStudents ?? '862'); ?></h5>
            ...
            <div class="col">
                <div class="card radius-10" style="background:linear-gradient(135deg,#c0392b,#e74c3c);">
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            <h5 class="mb-0 text-white kpi-value"><?php echo e($pendingPayments ?? '139'); ?></h5>
...
<?php echo $__env->make('admin.admin_dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\PROJECT2\KIMIS\resources\views/admin/index.blade.php ENDPATH**/ ?>