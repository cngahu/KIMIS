<?php $__env->startSection('admin'); ?>
    <div class="container">
        <div class="d-flex justify-content-between align-items-center mb-3">
            ...
            <div>
                <a href="<?php echo e(route('all.courses')); ?>" class="btn btn-light border me-2">Back to Courses</a>
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-md-6">
                        ...
                        <?php if($course->target_group): ?>
                            <p class="mt-2"><strong>Target Group:</strong><br><?php echo e($course->target_group); ?></p>
                        <?php endif; ?>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body">
                            ...
                            <?php $__currentLoopData = $course->requirements; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $req): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li class="list-group-item d-flex justify-content-between align-items-start">
                                    ...
                                    <div>
                                        ...
                                        <span class="badge bg-light text-dark mb-1"><?php echo e($req->type); ?></span>

                                        <div><?php echo nl2br(e($req->course_requirement)); ?></div>
                    ...
                    <?php else: ?>
                        <p class="text-muted mb-0">
                            ...
                            <a href="<?php echo e(route('courses.requirements.create', $course)); ?>">Click here to add one.</a>
                        </p>
                    <?php endif; ?>
                </div>
            </div>
