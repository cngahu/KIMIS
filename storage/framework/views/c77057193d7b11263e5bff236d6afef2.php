...
<div class="wrapper">
    <!--sidebar wrapper -->
    <?php echo $__env->make('applicant.body.sidebar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <!--end sidebar wrapper -->

    <!--start header -->
    <?php echo $__env->make('applicant.body.header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <!--end header -->

    <!--start page wrapper -->
    <div class="page-wrapper">
        <?php echo $__env->yieldContent('applicant'); ?>
    </div>
    <!--end page wrapper -->
    ...
    <?php echo $__env->make('applicant.body.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
</div>
...
<script src="<?php echo e(asset('adminbackend/assets/plugins/datatable/js/dataTables.bootstrap5.min.js')); ?>"></script>
<script>
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        forms.forEach(function (form) {
            form.addEventListener('submit', function (e) {
                ...
                const confirmButtonText = form.dataset.confirmButton || 'Yes, proceed';
...
<?php /**PATH C:\xampp\htdocs\PROJECT2\KIMIS\resources\views/applicant/applicant_dashboard.blade.php ENDPATH**/ ?>