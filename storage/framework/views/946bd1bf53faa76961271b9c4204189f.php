...
unset($__errorArgs, $__bag); ?>"
                    ...
                    value="<?php echo e(old('cost', $course->cost ?? 0)); ?>"
                >
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="col-md-3">
                ...
                <select
                    name="requirement"
                    class="form-select <?php $__errorArgs = ['requirement'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                >
                    ...
                    ?>
                    <option value="1" <?php echo e($requirementValue == 1 ? 'selected' : ''); ?>>Yes</option>
                    <option value="0" <?php echo e($requirementValue == 0 ? 'selected' : ''); ?>>No</option>
                </select>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="col-md-12">
                ...
                <textarea
                    name="target_group"
                    rows="2"
                    class="form-control <?php $__errorArgs = ['target_group'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                ...
                ><?php echo e(old('target_group', $course->target_group ?? '')); ?></textarea>
                <?php $__errorArgs = ['target_group'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
