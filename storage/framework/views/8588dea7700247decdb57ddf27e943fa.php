                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="tab-pane" id="settings">
                                <form id="myForm" method="post" action="<?php echo e(route('role.permission.update',$role->id)); ?>" enctype="multipart/form-data">
                                    <?php echo csrf_field(); ?>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-9">
                                                    ...
                                                    <?php $__currentLoopData = $permissions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $permission): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <div class="form-check mb-2 form-check-primary">
                                                            <input class="form-check-input" type="checkbox" name="permission[]" <?php echo e($role->hasPermissionTo($permission->name) ? 'checked' : ''); ?> value="<?php echo e($permission->name); ?>" id="customckeck<?php echo e($permission->id); ?>"  >
...
<?php echo $__env->make('admin.admin_dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\PROJECT2\KIMIS\resources\views/backend/pages/roles/edit_roles_permission.blade.php ENDPATH**/ ?>