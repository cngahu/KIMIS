    ...
    <div class="page-content">
        ...
        <div class="card border-top border-left  border-0 border-4 border-success">
            <div class="card-body p-5">
                ...
                <hr>
                <form class="row g-3" id="myForm" method="post" action="<?php echo e(route('primaryeducation.store')); ?>" enctype="multipart/form-data" >
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('applicant.applicant_dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\pck.go.ke\resources\views/applicant/apply/education_primary.blade.php ENDPATH**/ ?>