            ...
            <table width="600" cellpadding="0" cellspacing="0" style="background:#ffffff; border-radius:8px; overflow:hidden;">
                ...
                ">
                            <div style="margin-bottom:5px;">
                                <strong>Login attempt:</strong> <?php echo e($date); ?>

                            </div>
                            <div>
                                <strong>IP Address:</strong> <?php echo e($ip); ?>
                ...
                color:#6b7280;
            ">
                        © <?php echo e(date('Y')); ?> Kenya Institute of Highways and Building Technology (KIHBT). All rights reserved.<br>
...
<?php /**PATH C:\xampp\htdocs\PROJECT2\KIMIS\resources\views/emails/otp-html.blade.php ENDPATH**/ ?>