<div class="sidebar-wrapper" data-simplebar="true">
    <div class="sidebar-header">
        <div>
            <a href="<?php echo e(route('dashboard')); ?>">    <img src="<?php echo e(asset('adminbackend/assets/images/logo-icon.png')); ?>" class="logo-icon" alt="logo icon">
            </a>
        </div>
        <div>
    ...
    <ul class="metismenu" id="menu">
        ...
        <li>
            ...
            <ul>
                <li> <a href="<?php echo e(route('all.permission')); ?>"><i class="bx bx-right-arrow-alt"></i>All Permissions</a>
                </li>
                <li> <a href="<?php echo e(route('all.roles')); ?>"><i class="bx bx-right-arrow-alt"></i>Roles</a>
                </li>
                <li> <a href="<?php echo e(route('all.roles.permission')); ?>"><i class="bx bx-right-arrow-alt"></i>Roles in Permission </a>
                </li>
        ...
        <li>
            ...
            <ul>
                <li> <a href=""><i class="bx bx-right-arrow-alt"></i>County</a>
                </li>
...
<?php /**PATH C:\xampp\htdocs\rukada starter\resources\views/admin/body/sidebar.blade.php ENDPATH**/ ?>