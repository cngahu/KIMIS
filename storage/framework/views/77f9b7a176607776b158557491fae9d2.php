                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="tab-pane" id="settings">
                                <form id="myForm" method="post" action="<?php echo e(route('permission.store')); ?>" enctype="multipart/form-data">
                                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.admin_dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\PROJECT2\KIMIS\resources\views/backend/pages/permission/add_permission.blade.php ENDPATH**/ ?>