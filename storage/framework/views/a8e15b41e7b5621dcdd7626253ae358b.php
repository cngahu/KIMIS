<?php $__env->startSection('admin'); ?>
    ...
    <div class="page-content">
        ...
        <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            ...
            <div class="ms-auto">
                <div class="btn-group">
                    <a href="<?php echo e(route('add.permission')); ?>" class="btn btn-primary">Add Permission</a>
                </div>
            </div>
        </div>
        <!--end breadcrumb-->
...
<?php echo $__env->make('admin.admin_dashboard', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\rukada starter\resources\views/backend/pages/permission/all_permission.blade.php ENDPATH**/ ?>