                        ...
                        <div class="col-12" id="departments_wrapper" style="display:none;">
                            ...
                            <div id="departments_box"
                                ...
                                <div class="text-muted small">
                                    Select campus to load academic departments…
                                </div>
                            </div>
                            ...
                            <small class="text-muted">
                                Select one or more departments this HOD will manage.
                                <br>
                                <strong>Courses and cohorts will be derived automatically.</strong>
                            </small>
                        </div>
        ...
        (function () {
            ...
            function renderDepartments(departments, selectedIds) {
                if (!departments.length) {
                    renderMessage('No academic departments found for this campus.');
                    return;
                }
            ...
            async function loadDepartments() {
                ...
                if (!isHod()) {
                    renderMessage('Departments hidden (role not HOD).');
                    return;
                }

                const campusId = campusSelect.value;
                if (!campusId) {
                    renderMessage('Select campus to load academic departments…');
                    return;
                }
                ...
                try {
                    const url = `{{ route('admin.academic-departments.byCampus', ':id') }}`.replace(':id', campusId);
                    ...
                    const oldSelected = @json(old('academic_department_ids', [])).map(String);

                    renderDepartments(departments, oldSelected);
                } catch (e) {
                    console.error(e);
