...
@section('admin')
    @php
        ...
        $context = $context ?? 'users'; // 'users' or 'students'
        $backRoute = $backRoute ?? route('admin.users.index');
        $lockRoleToStudent = $lockRoleToStudent ?? false;
    @endphp
    ...
    <div class="page-content">
        ...
        <div class="d-flex justify-content-between align-items-center mb-3">
            <h4 class="mb-0">
                {{ $context === 'students' ? 'Edit Student' : 'Edit User' }}
            </h4>
            <a href="{{ $backRoute }}" class="btn btn-light border btn-sm">Back</a>
        </div>
                ...
                <form action="{{ route('admin.users.update', $user) }}" method="POST">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-6">
                            ...
                            @if($lockRoleToStudent)
                                {{-- lock role to student --}}
                        ...
                        {{-- Campus + Departments ONLY for non-students context --}}
                        @if($context !== 'students')
                    ...
                    <div class="d-flex justify-content-end gap-2">
                        <a href="{{ $backRoute }}" class="btn btn-light border">Cancel</a>
    ...
    {{-- JS ONLY for non-students context --}}
    @if($context !== 'students')
        <script>
            (function () {
                ...
                if (!roleSelect || !campusSelect || !depWrap || !depBox) return;
