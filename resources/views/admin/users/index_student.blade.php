    ...
    <div class="page-content">
        ...
        <div class="d-flex justify-content-between align-items-center mb-3 flex-wrap gap-2">
            <div>
                ...
                <small class="text-muted">Showing only users with role: <strong>student</strong></small>
            </div>

            <div class="d-flex gap-2">
                <a href="{{ route('admin.users.index') }}" class="btn btn-outline-secondary btn-sm">
                    <i class="bx bx-left-arrow-alt"></i> All Users
                </a>
        ...
        <div class="card radius-10 mb-3">
            <div class="card-body">
                <form action="{{ route('admin.users.students') }}" method="GET" class="row g-2 align-items-end">
                    ...
                    @forelse($users as $index => $user)
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="{{ route('admin.users.students.edit', $user) }}"
