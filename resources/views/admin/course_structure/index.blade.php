...
{{--                        </span>--}}
{{--                            @if($row->stage)--}}
{{--                                <strong>{{ $row->stage->code }}</strong> – {{ $row->stage->name }}--}}
{{--                            @else--}}
{{--                                <span class="text-danger">[Missing stage]</span>--}}
{{--                            @endif--}}
...
{{--                --}}{{-- COURSE STRUCTURE --}}
{{--                <div class="col-md-7">--}}
{{--                    <h6 class="mb-2">Course Structure (Order matters)</h6>--}}

{{--                    <ul id="structureList" class="list-group structure-list">--}}
...
{{--    --}}{{-- SIMPLE JS (NO LIBRARIES) --}}
{{--    <script>--}}
{{--        const structureList = document.getElementById('structureList');--}}

{{--        // ADD STAGE--}}
{{--        document.querySelectorAll('.add-stage').forEach(btn => {--}}
...
{{--                structureList.innerHTML = `<li class="structure-empty">No stages added yet.</li>`;--}}
{{--            }--}}
{{--        }--}}

{{--        function removeEmptyMessage() {--}}
{{--            const empty = structureList.querySelector('.structure-empty');--}}
