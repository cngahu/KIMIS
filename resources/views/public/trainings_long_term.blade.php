...
<head>
    ...
    <title>Scheduled Trainings (Long Term) – KIHBT</title>
...
<div class="boxed-container">
    ...
    <section class="page-hero">
        <h1>Scheduled Trainings (Long Term)</h1>
        <p>Explore approved long term training programmes across all KIHBT campuses and register online.</p>
    </section>

    {{-- Filters --}}
    <section class="filters-wrapper">
        <form action="{{ route('public.trainings.long') }}" method="GET" class="w-100 mb-3">
            <div class="row g-2 align-items-center">
                ...
                <div class="col-md-5 d-flex gap-2 justify-content-md-end">
                    ...
                    @if(request('search') || request('college_id'))
                        <a href="{{ route('public.trainings.long') }}" class="btn btn-sm btn-outline-secondary">
    ...
    <section class="table-container">
        ...
        @else
            <div class="alert alert-info mx-3 mb-3">
                No approved long term trainings found
                @if(request('search') || request('college_id'))
                    for the current filters.
                    <a href="{{ route('public.trainings.long') }}">Clear filters</a>
                @else
