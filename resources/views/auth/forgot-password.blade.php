...
<head>
    ...
    <style>
        ...
        *{margin:0;padding:0;box-sizing:border-box;}
        ...
        .info-highlight p{font-size:.9rem;color:#e8ddce;max-width:360px;line-height:1.45; text-align: center;}
    ...
    <div class="auth-layout">
        ...
        <section class="form-column">
            <div class="login-card">
                ...
                <div class="reset-subtitle">You can reset your password here.</div>
