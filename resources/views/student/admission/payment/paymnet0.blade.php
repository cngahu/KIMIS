...
@section('content')
            ...
            <div class="card shadow-sm mb-4">
                ...
                <div class="card-body">
                    ...
                    @if($application->invoice->status !== 'paid')
                        ...
                        <button id="startPayment" class="btn btn-success btn-lg w-100 mb-3">
                            Pay Now
                        </button>
                ...
                <div id="iframeContainer" style="display: none; margin-top: 20px;">
                    ...
                    <iframe
                        name="payment_iframe"
                        style="width:100%; height:800px; border:0; margin-top:10px;">
                    </iframe>
                </div>
    ...
    <script>
        document.getElementById('startPayment').addEventListener('click', function() {
            ...
            document.getElementById('ecitizenForm').submit();

            // Optional: Scroll to iframe
            window.scrollTo({
                top: document.getElementById('iframeContainer').offsetTop,
                behavior: 'smooth'
            });
        });
    </script>
