...
@section('applicant')
    ...
    <div class="page-content">
        ...
        <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            <div class="breadcrumb-title pe-3">SECTION 3 </div>
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        <li class="breadcrumb-item"><a href="javascript:;"><i class="bx bx-home-alt"></i></a>
                        </li>
                        <li class="breadcrumb-item active" aria-current="page">SECONDARY SCHOOL DETAILS </li>
                    </ol>
                </nav>
            </div>
            <div class="ms-auto">
        ...
        <div class="card border-top border-left  border-0 border-4 border-success">
            <div class="card-body p-5">
                ...
                <hr>
                <form class="row g-3" id="myForm" method="post" action="{{ route('secondaryeducation.store') }}" enctype="multipart/form-data" >
                    @csrf
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <label for="institutionName" class="form-label " style="font-size:large">Secondary School Name</label>
