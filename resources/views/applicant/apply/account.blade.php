    ...
    <div class="page-content">
        ...
        <div class="card border-top border-left  border-0 border-4 border-success">
            <div class="card-body p-5">
                ...
                @endif
                <form class="row g-3" id="myForm" method="post" action="{{ route('register.store') }}" enctype="multipart/form-data" >
                    @csrf
                    <input type="hidden" name="userid" value="{{$user->id}}">
                        ...
                        <div class="col-md-6 form-group">
                            <label for="surname" class="form-label " style="font-size:large">Surname</label>
                                ...
                                <input  type="text" name="surname" value="{{$user->surname}}"  class="form-control" id="surname" placeholder="Staff Name" />
                    ...
                    <div class="col-md-6 form-group">
                            <label for="othername" class="form-label " style="font-size:large">Other Names</label>
                                ...
                                <input type="text" name="othername" value="{{$user->othername}}"  class="form-control" id="othername" placeholder="Other Names" />
                            ...
                            <div class="form-group">
                                <select name="title_id" id="title_id" required="" class="form-control">
                                    ...
                                    @foreach($titles as $item)
                                        <option value="{{ $item->id }}" {{ old('title_id') == $item->id ? 'selected' : '' }}>{{ $item->name }}</option>
                                    @endforeach
                    ...
                    <div class="col-md-6 form-group">
                            ...
                            <div class="form-group">
                                <select name="nationality" id="nationality" required="" class="form-control">
                                    ...
                                    @foreach($nationalities as $item)
                                        <option value="{{ $item->id }}" {{ old('nationality') == $item->id ? 'selected' : '' }}>{{ $item->name }}</option>
                                    @endforeach
                    ...
                    <div class="col-md-6 form-group">
                            ...
                            <div class="form-group">
                                <select name="county" id="county" required="" class="form-control">
                                    ...
                                    @foreach($counties as $item)
                                        <option value="{{ $item->id }}" {{ old('county') == $item->id ? 'selected' : '' }}>{{ $item->name }}</option>
                                    @endforeach
                        ...
                        <div class="col-md-6 form-group">
                            <label for="address" class="form-label " style="font-size:large" >Permanent Postal Address</label>
                                ...
                                <input type="text" name="address" value="{{old('address')}}"  class="form-control" id="address" placeholder="Postal Address-Code eg 62000-00200" />
                    ...
                    <div class="col-md-6 form-group">
                            <label for="inputLastName2" class="form-label" style="font-size:large">Postal City/Town</label>
                                ...
                                <input type="text" name="city"  value="{{old('city')}}" class="form-control" id="city" placeholder="Postal City" />

                        </div>
                    <div class="col-md-6 form-group">
                            <label for="physical_address" class="form-label" style="font-size:large" >Physical Address</label>

                                <input name="physical_address" value="{{old('physical_address')}}" class="form-control" type="text" id="physical_address" placeholder="Physical Address">
                    ...
                    <div class="col-md-6 form-group">
                            <label for="nationalid" class="form-label" style="font-size:large">National ID/Passport Number</label>
                                ...
                                <input type="text" name="nationalid" value="{{old('nationalid')}}"  class="form-control" id="nationalid" placeholder="ID/Passport Number" />
                    ...
                    <div class="col-md-6 form-group">
                            <label for="next_of_kin" class="form-label" style="font-size:large">Next of Kin Name</label>
                                ...
                                <input type="text" name="next_of_kin" value="{{old('next_of_kin')}}"  class="form-control" id="next_of_kin" placeholder="Next of Kin Name" />

                        </div>
                    <div class="col-md-6 form-group">
                            <label for="inputLastName2" class="form-label" style="font-size:large">Next of Kin Contact</label>

                                <input type="text" name="next_of_kin_contact" value="{{old('next_of_kin_contact')}}"  class="form-control" id="next_of_kin_contact" placeholder="Next of Kin Contact" />
                    ...
                    <div class="col-md-6 form-group">
                            <label for="inputLastName2" class="form-label" style="font-size:large" >National ID/Passport (PDF Format, Not larger than 2mb)</label>
                                ...
                                <x-input-error :messages="$errors->get('national_id')" style="color: red" class="mt-2" />
                    ...
                    <div class="col-md-6 form-group">
                            ...
                            <div class="form-group">
                                ...
                                <x-input-error :messages="$errors->get('photo')" style="color: red" class="mt-2" />
